...
class HttpTest {
	@Test void testHttp(){
		...
		URL url = new URL("http://www.yayjy.com/list.asp?id=5439")
...
//			return resp.getEntity().getContent().getText("gb2312")
//		}
		println new HttpRequester().get("http://www.yayjy.com/list.asp?id=5439", "gb2312");
